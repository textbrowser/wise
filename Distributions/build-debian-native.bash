...
if [ $architecture = "arm64" ]
then
    fakeroot dpkg-deb --build wise-debian.d Wise-2026.05.20_PiOS_arm64.deb
elif [ $architecture = "armhf" ]
then
    fakeroot dpkg-deb --build wise-debian.d Wise-2026.05.20_PiOS_arm32.deb
else
    fakeroot dpkg-deb --build wise-debian.d Wise-2026.05.20_Kubuntu_amd64.deb
fi
